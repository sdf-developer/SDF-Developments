...
const TRANSLATIONS = {
  en: {
    ...
    title_terms:        '<span class="accent">TERM</span>S',
    ...
    terms_contact_label:'Questions?',
    terms_contact_text: 'If you have any questions about these terms, feel free to contact us.',
  ...
  es: {
    ...
    nav_terms:          'Términos',
    eyebrow_terms:      'SDF Survival Core · Legal',
    title_terms:        '<span class="accent">TÉRM</span>INOS',
    sub_terms:          'TÉRMINOS Y CONDICIONES',
    tagline_terms:      'Lee estos términos detenidamente antes de adquirir o utilizar SDF Survival Core.',
    terms_last_updated: 'Última actualización',
    terms_s1_title:     '1. Licencia',
    terms_s1_body:      'SDF Survival Core se vende como licencia para un único servidor. Cada compra te otorga el derecho a usar el plugin en un (1) servidor de Minecraft. No puedes redistribuir, revender, compartir ni sublicenciar el plugin o su código fuente a terceros.',
    terms_s2_title:     '2. Política de Reembolso',
    terms_s2_body:      'Debido a la naturaleza digital de este producto, todas las ventas son definitivas. Los reembolsos solo se conceden si el plugin resulta ser no funcional en un entorno de servidor compatible (Paper 1.21+) y el problema no puede resolverse mediante soporte.',
    terms_s3_title:     '3. Actualizaciones y Soporte',
    terms_s3_body:      'Tu licencia incluye acceso a todas las actualizaciones futuras de la versión mayor adquirida. El soporte se proporciona vía Discord y correo electrónico. Intentamos responder en 24–48h en días laborables.',
    terms_s4_title:     '4. Usos Prohibidos',
    terms_s4_body:      'No puedes descompilar, realizar ingeniería inversa, modificar ni redistribuir públicamente los archivos del plugin. Está estrictamente prohibido utilizar el plugin para perjudicar, explotar u obtener ventajas injustas sobre otros operadores de servidores o jugadores.',
    terms_s5_title:     '5. Responsabilidad',
    terms_s5_body:      'SDF Development no se hace responsable de caídas del servidor, pérdida de datos u otros daños derivados del uso o mal uso de SDF Survival Core. Es tu responsabilidad mantener copias de seguridad de los datos de tu servidor.',
    terms_s6_title:     '6. Cambios en los Términos',
    terms_s6_body:      'Nos reservamos el derecho de actualizar estos términos en cualquier momento. El uso continuado del plugin tras los cambios implica la aceptación de los nuevos términos. Anunciaremos cambios significativos en nuestro servidor de Discord.',
    terms_contact_label:'¿Preguntas?',
    terms_contact_text: 'Si tienes alguna pregunta sobre estos términos, no dudes en contactarnos.',
  ...
  fr: {
    ...
    title_terms:        '<span class="accent">CONDI</span>TIONS',
    ...
    terms_s1_body:      'SDF Survival Core est vendu sous licence pour un seul serveur. Chaque achat vous donne le droit d\'utiliser le plugin sur un (1) serveur Minecraft. Vous ne pouvez pas redistribuer, revendre, partager ou sous-licencier le plugin ou son code source à des tiers.',
    terms_s2_title:     '2. Politique de Remboursement',
    terms_s2_body:      'En raison de la nature numérique de ce produit, toutes les ventes sont définitives. Les remboursements ne sont accordés que si le plugin s\'avère non fonctionnel dans un environnement serveur compatible (Paper 1.21+) et que le problème ne peut être résolu par le support.',
    terms_s3_title:     '3. Mises à Jour & Support',
    terms_s3_body:      'Votre licence inclut l\'accès à toutes les futures mises à jour de la version majeure achetée. Le support est fourni via Discord et e-mail. Nous visons à répondre dans les 24–48h les jours ouvrables.',
    terms_s4_title:     '4. Utilisations Interdites',
    terms_s4_body:      'Vous ne pouvez pas décompiler, désosser, modifier ou redistribuer publiquement les fichiers du plugin. L\'utilisation du plugin pour nuire, exploiter ou obtenir un avantage injuste sur d\'autres opérateurs de serveur ou joueurs est strictement interdite.',
    terms_s5_title:     '5. Responsabilité',
    terms_s5_body:      'SDF Development n\'est pas responsable des temps d\'arrêt du serveur, des pertes de données ou des autres dommages résultant de l\'utilisation ou de l\'utilisation abusive de SDF Survival Core. Il est de votre responsabilité de conserver des sauvegardes de vos données serveur.',
    terms_s6_title:     '6. Modifications des Conditions',
    terms_s6_body:      'Nous nous réservons le droit de mettre à jour ces conditions à tout moment. L\'utilisation continue du plugin après les modifications constitue une acceptation des nouvelles conditions. Nous annoncerons les changements importants via notre serveur Discord.',
    terms_contact_label:'Des questions ?',
    terms_contact_text: 'Si vous avez des questions concernant ces conditions, n\'hésitez pas à nous contacter.',
...
function applyLang(lang) {
  ...
  const navMap = {
    ...
    'nav-contact': 'nav_contact', 'nav-terms': 'nav_terms'
  };
  ...
  if (page === 'changelog.html') {
    ...
    setText('eyebrow-changelog', T.eyebrow_changelog);
    setText('tagline-changelog', T.tagline_changelog);
    setText('status-label', T.status_label);
    setText('status-text', T.status_text);
    setText('versions-label', T.versions_label);
    setText('v1-title', T.v1_title);
    setText('v1-date', T.v1_date);
    setText('badge-latest', T.badge_latest);
    setText('badge-initial', T.badge_initial);
    setText('prerelease-text', T.prerelease_text);
  }

  if (page === 'terms.html') {
    setHTML('eyebrow-terms', T.eyebrow_terms);
    setHTML('title-terms', T.title_terms);
    setText('sub-terms', T.sub_terms);
    setText('tagline-terms', T.tagline_terms);
    setText('terms-last-updated', T.terms_last_updated);
    ...
    setText('terms-contact-label', T.terms_contact_label);
    setText('terms-contact-text', T.terms_contact_text);
    setText('terms-contact-cta', T.terms_contact_cta);
  }

  // Nav labels presente en todas las páginas
  setText('nav-integrations', T.nav_integrations);
  setText('nav-terms', T.nav_terms);
}
...
function injectComingSoonPopup() {
  ...
  style.textContent = `
    ...
    #cs-overlay.visible { opacity: 1; pointer-events: all; }
    #cs-overlay.hiding { opacity: 0; pointer-events: none; }
    #cs-box {
      position: relative;
      background: #18181b;
    ...
    #cs-overlay.visible #cs-box { opacity: 1; transform: scale(1) translateY(0); }
    #cs-top-line {
      height: 2px;
  ...
  `;
  document.body.appendChild(overlay);
  // Activar con pequeño timeout para que el navegador pinte el estado inicial primero
  setTimeout(() => { if (overlay.parentNode) overlay.classList.add('visible'); }, 120);
